...
Topic description: Records primarily about general AI literacy, LLM education, prompt engineering, AI courses, model usage guidance, AI training resources, or non-security AI learning material.
Total records: 1
Record IDs: 2178
...
## [record_id:2178]
Source: promptorgtfo
Source record ID: https://www.youtube.com/watch?v=Ap_wwdoBHdQ
Title: Community Discussion | Prompt||GTFO #6 - S02E01
Author: 
Event: Prompt||GTFO
Year: 2026
URL: https://www.youtube.com/watch?v=Ap_wwdoBHdQ
Tags: GDAU; CodeQL Helper; Obsidian; Zero; gamma.app; Chip and Pixel Lab; ChatGPT
Topic membership: primary
Primary topic: General AI education and prompt engineering
Secondary topics: 

Raw record text:
```text
This is the open community discussion segment from Prompt||GTFO S02E01, where attendees recap tools and demos shown during the episode's presentations and discuss cultural attitudes toward AI among kids, gamers, schools, and creative professionals.
```